...
"""
    ...
    def test_find_current_meeting(self, temp_vault, sample_meeting_note):
        ...
        current = matcher.find_current_meeting(meetings_dir, current_time + timedelta(minutes=30))
    ...
    def test_no_current_meeting(self, temp_vault, sample_meeting_note):
        ...
        current = matcher.find_current_meeting(meetings_dir, current_time + timedelta(hours=2))
...
"""
        ...
        upcoming = matcher.find_upcoming_meeting(meetings_dir, now, lookahead_minutes=15)
