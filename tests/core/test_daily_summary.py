...
class TestDailySummaryGenerator:
    ...
    def test_generate_daily_summary_with_schedule(self, mock_vault_connection, sample_events):
        ...
        assert '**09:00-09:30** | [[2024-01-15 Morning Standup]] | 📍 Conference Room A' in content
        assert '**14:00-15:30** | [[2024-01-15 Budget Review]] | 💻 Online' in content
        assert '**16:00-17:00** | [[2024-01-15 Project Planning]]' in content
    
    def test_generate_daily_summary_with_attendees(self, mock_vault_connection, sample_events):
        ...
        assert '[[Alice Johnson]], [[Bob Wilson]], [[Carol Davis]], [[Dave Miller]], [[Eve Brown]] +1 more' in content
    
    def test_generate_daily_summary_time_grouping(self, mock_vault_connection, sample_events):
    ...
    def test_generate_daily_summary_action_items_section(self, mock_vault_connection, sample_events):
    ...
    def test_generate_daily_summary_reflection_section(self, mock_vault_connection, sample_events):
