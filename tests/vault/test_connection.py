...
class TestVaultConnection:
    ...
    def test_ensure_folder_exists_with_nested_path(self):
        ...
        # Mock a nested path
        self.mock_config.get_location.side_effect = lambda t: self.vault_path / '1-Projects/Work/Meetings' if t == 'calendar_events' else None
...
Meeting notes here."""
    ...
    def test_get_note_path(self):
        ...
        # Get path for a note
        path = conn.get_note_path("2024-01-15 Meeting.md", folder_type='calendar_events')
    ...
    def test_connection_with_unconfigured_location(self):
        ...
        with pytest.raises(ValueError, match="Location type 'unknown_type' not configured"):
