    ...
    def test_load_existing_config(self):
        ...
        with patch('builtins.open', mock_open(read_data=yaml.dump(config_data))):
            with patch('pathlib.Path.exists', return_value=True):
                ...
                assert config.get_location('calendar_events') == Path('/Users/test/MyVault/Meetings')
                assert config.get_location('daily_notes') == Path('/Users/test/MyVault/Daily Notes')
    ...
    def test_get_location_with_nested_paths(self):
        ...
        with patch('builtins.open', mock_open(read_data=yaml.dump(config_data))):
            with patch('pathlib.Path.exists', return_value=True):
                ...
                assert config.get_location('calendar_events') == Path('/Users/test/Vault/1-Projects/Work/Meetings')
                assert config.get_location('gtd_inbox') == Path('/Users/test/Vault/00-Inbox')
