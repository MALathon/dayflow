...
class VaultConfig:
    ...
    def vault_path(self) -> Path:
        ...
        if not path:
            raise VaultConfigError(
                "Vault path not configured. Run 'dayflow vault init' to set up."
            )
        return Path(path)
    ...
    def set_location(self, location_type: str, path: str):
        ...
        self.config.setdefault("vault", {}).setdefault("locations", {})[
            location_type
        ] = path
        self._save_config()
    ...
    def get_setting(self, key: str, default=None):
        ...
        Args:
            key: Setting key in dot notation (e.g., "calendar.folder_organization")
